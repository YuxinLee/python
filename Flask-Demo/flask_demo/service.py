...
app = Flask(__name__)
#行语句就是把一行当成是jinjia2的语句行，设置一下jinjia2的line_statement_prefix变量即可实现。比如设置为“#”，可以替换{% %}
app.jinja_env.line_statement_prefix = '#'
#页面之间flash信息进行交互，需要设置session唯一的id，唯一的随机数
